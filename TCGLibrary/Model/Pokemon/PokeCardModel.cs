...
//    using PKCQuickType;
//
//    var pokeCardModel = PokeCardModel.FromJson(jsonString);

namespace PKCQuickType
{
    using System;
    ...
    public partial class PokeCardModel
    {
        public static PokeCardModel FromJson(string json) => JsonConvert.DeserializeObject<PokeCardModel>(json, PKCQuickType.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this PokeCardModel self) => JsonConvert.SerializeObject(self, PKCQuickType.Converter.Settings);
    }
